...
namespace ECAT_TEST_PREP
{
    public partial class ECAT_2_ : Form
    {
        ...
        OleDbConnection con = new OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=C:/Users/Waqar/Desktop/ECAT(DATABASE).accdb;");
            ...
            if (DATAS.Design_Pattern_status == 1)
            {
                ...
                if (DATAS.review == 0)
                {
                    ...
                    else
                    {
                        ...
                        minute_eng = time_eng % 60;
                        hours_math = time_math / 60;
                        minute_math = time_math % 60;
                        hours_phy = time_phy / 60;
                        minute_phy = time_phy % 60;
                        hours_chem = time_chem / 60;
                        minute_chem = time_chem % 60;
        ...
        private void time_Tick(object sender, EventArgs e)
        {
            if (DATAS.whole_MCQS_TIME_status == 1)
            {
                ...
                if (seconds_t == -1)
                {
                    if ((seconds_t == -1) && (minute_t == 0) && (hours_t == 0))
                    { Close(); SCORE SR = new SCORE(); SR.Show(); }
                    minute_t--; seconds_t = 59; min_ned_nust.Text = minute_t.ToString();

                }
                if (minute_t == -1 && hours_t != 0)
                {
                    hours_t--; minute_t = 59;
                    hours_ned_nust.Text = hours_t.ToString();
                }
            ...
            else
            {
                if (serial_text1 <= em)
                {
                    ...
                    if (seconds_t == -1)
                    {
                        if ((seconds_t == -1) && (minute_eng == 0) && (hours_eng == 0))
                        { serial_text1 = em + 1; serial.Text = serial_text1.ToString(); }
                        min_ned_nust.Text = minute_eng.ToString(); minute_eng--; seconds_t = 59;
                ...
                else if (serial_text1 <= em+cm)
                {
                    ...
                    if (seconds_t == -1)
                    {
                        if ((seconds_t == -1) && (minute_chem == 0) && (hours_chem == 0))
                        { serial_text1 = em + cm + 1; serial.Text = serial_text1.ToString(); }
                        min_ned_nust.Text = minute_chem.ToString(); minute_chem--; seconds_t = 59;
                ...
                else if (serial_text1 <= em+cm+pm)
                {
                    ...
                    if (seconds_t == -1)
                    {
                        if ((seconds_t == -1) && (minute_phy == 0) && (hours_phy == 0))
                        { serial_text1 = em + cm + pm + 1; serial.Text = serial_text1.ToString(); }
                        min_ned_nust.Text = minute_phy.ToString(); minute_phy--; seconds_t = 59;
                ...
                if (serial_text1 <= em+cm+pm+mm)
                {
                    ...
                    if (seconds_t == -1)
                    {
                        if ((seconds_t == -1) && (minute_math == 0) && (hours_math == 0))
                        { Close(); SCORE SR = new SCORE(); SR.Show(); }
                        min_ned_nust.Text = minute_math.ToString(); minute_math--; seconds_t = 59;
